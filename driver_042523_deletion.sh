...
submit_jobs() {
    ...
    do
        ...
        #output_file=/scratch/users/taowang9/${runDate}/files.deletion/${tfs[$id]}
        #
        ...
        sbatch --wait predict_single_round4_deletion.sh $id ${cell_line} &
        pids[${id}]=$!
...
statistical_test() {
    ...
    # median
    Rscript statistics.R ${SCRATCH}/042523/files.deletion "median_ref.txt" "median_var.txt" "tf1_with_tf2_motif_deleted_median.tsv"

    # median of median
    #Rscript statistics.R ${SCRATCH}/042523/files.deletion "median_of_median_ref.txt" "median_of_median_var.txt" "tf1_with_tf2_motif_scrambled_median_of_median.tsv"
}
